'''
GCN node classification on the Cora dataset.
Target: 80%+ test accuracy.

Run from project root:
    python -m script.stage_5_script.script_cora
'''
...
if __name__ == '__main__':
    ...
    # ---- data ----
    data_obj = Dataset_Loader(dName=DATASET, dDescription='Cora citation network')
