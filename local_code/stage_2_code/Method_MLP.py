...
class Method_MLP(method, nn.Module):
    ...
    def __init__(self, mName, mDescription):
        ...
        self.fc_layer_1 = nn.Linear(784,128) #to match dataset
        # check here for nn.ReLU doc: https://pytorch.org/docs/stable/generated/torch.nn.ReLU.html
        self.activation_func_1 = nn.ReLU()
        self.fc_layer_2 = nn.Linear(128, 10) #to match dataset
    ...
    def forward(self, x):
        ...
        #since crossentropyloss requires raw not softmax probabilities i used:
