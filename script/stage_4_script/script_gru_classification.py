'''
Stage 4-5: GRU for IMDB sentiment classification.
Identical setup to the base RNN script; only the recurrent cell changes to GRU.
Run from project root:
    python -m script.stage_4_script.script_gru_classification
'''
