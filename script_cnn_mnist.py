'''
Script to train and evaluate CNN on MNIST handwritten digit dataset
Run from project root: python -m script.stage_3_script.script_cnn_mnist
'''
...
if __name__ == '__main__':
    ...
    # ---- load data ----
    data_obj = Dataset_Loader('mnist', 'MNIST handwritten digits')
    data_obj.dataset_source_folder_path = './data/stage_3_data/'
    data_obj.dataset_source_file_name   = 'MNIST'
    data_obj.dataset_type               = 'MNIST'
    ...
    result_obj.result_destination_folder_path = './result/stage_3_result/CNN_MNIST'
    ...
    # ---- plots ----
    plot_dir = './result/stage_3_result/CNN_MNIST'
    ...
    print_training_summary(method_obj.train_losses, method_obj.train_accuracies, 'CNN_MNIST')
    plot_loss_convergence_detailed(method_obj.train_losses, save_dir=plot_dir, model_name='CNN_MNIST')
